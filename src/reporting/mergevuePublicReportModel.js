...
export function buildMergevuePublicReportModel(session = {}, options = {}) {
  ...
  return {
    ...
    economicRiskTranslation: {
      ...
      evUse: "EV sizes materiality context only. It is not scored in the public preview and does not produce a value-impact estimate.",
      ...
      whatThisPreviewCannotSay: "This is not a valuation, loss estimate, impairment opinion, damages calculation, or deal-approval finance deliverable.",
