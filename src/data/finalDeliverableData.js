...
export const FINAL_DELIVERABLE_DATA = Object.freeze({
  ...
  "frictionPoints": [
    ...
    },
    {
      ...
      "earlyWarningSignal": "Within 30 days: observe how NF/SFJ acquirer management responds to the first analytical challenge to a core belief raised by a target employee from NT/STJ. 'That misunderstands what we are about' as a response to an analytically sound challenge confirms the heresy mechanism is active.",
    ...
    },
    {
      ...
      "earlyWarningSignal": "Within 30 days: observe whether STJ/STP acquirer leadership applies the same review and consequence process to a senior target figure from NT/STJ as they would to a junior one. Asymmetric treatment of the first significant performance issue at senior level is the clearest and fastest confirmation that STJ/STP accountability logic is replacing NT/STJ's symmetric structure.",
