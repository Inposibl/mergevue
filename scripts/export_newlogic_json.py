...
def parse_scoring_and_triage():
    with Workbook(SOURCE_DIR / "ST_Dual_Respondent_Axis_Comparison_v1.xlsx") as dual:
        dual_artifact = {
            ...
            "questionTierVantage": table_records(
                dual,
                "11_Role_Question_Scope",
                "expectedVantage",
                block="questionTierVantage",
                stop_on_row_discontinuity=True,
            ),
            "roleQuestionOverride": table_records(
                dual,
                "11_Role_Question_Scope",
                "useClassCap",
                block="roleQuestionOverride",
                stop_on_row_discontinuity=True,
                allow_empty=True,
            ),
            "questionOptionSemantics": table_records(
                dual,
                "11_Role_Question_Scope",
                "optionCode",
                block="questionOptionSemantics",
                stop_on_row_discontinuity=True,
            ),
            "semanticClassEffects": table_records(
                dual,
                "11_Role_Question_Scope",
                "useClassEffect",
                block="semanticClassEffects",
                stop_on_row_discontinuity=True,
            ),
            "actualAccessCeiling": table_records(
                dual,
                "11_Role_Question_Scope",
                "useClassCeiling",
                block="actualAccessCeiling",
                stop_on_row_discontinuity=True,
            ),
