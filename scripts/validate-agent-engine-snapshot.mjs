...
check("V1", "contract identity: schema engine-snapshot-2.0, D0_R0_CORR2_A2C1_CORR1_C5C1_PC1_SR1, Core dcbd937", () => {
...
console.log("Agent EngineSnapshot slice C5-C (D0_R0_CORR2_A2C1_CORR1_C5C1_PC1_SR1) cases passed:");
